...
\bibitem{MF_Service} R. L¨¹bben and M. Fidler, "Service Curve Estimation-Based Characterization and Evaluation of Closed-Loop Flow Control," in IEEE Transactions on Network and Service Management, vol. 14, no. 1, pp. 161-175, March 2017.
\bibitem{MF_Estimation} R. L¨¹bben and M. Fidler, "Estimation method for the delay performance of closed-loop flow control with application to TCP," IEEE INFOCOM 2016 - The 35th Annual IEEE International Conference on Computer Communications, San Francisco, CA, 2016, pp. 1-9.
\bibitem{MF_Random} R. L¨¹bben, M. Fidler and J. Liebeherr, "Stochastic Bandwidth Estimation in Networks With Random Service," in IEEE/ACM Transactions on Networking, vol. 22, no. 2, pp. 484-497, April 2014.
