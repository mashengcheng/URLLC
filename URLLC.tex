...
\end{equation}
which $D_{Cloud}\geqslant A_{AAU}\otimes S_{AAU}\otimes S_{DU}\otimes S_{CU}\otimes S_{NGC}\otimes S_{Cloud}$. We have
\begin{equation}
\begin{split}
...
=&A_{AAU}(t)-A_{AAU}(s)-\beta_{gNB}\otimes\beta_{NGC}\otimes\beta_{Cloud}\\
&+A_{AAU}\otimes S_{gNB}\otimes S_{NGC}\otimes S_{Cloud} -D_{Cloud}(t+d)\\
=&A_{AAU}(s,t)-\alpha(t-s)\\
&+\alpha(t-s)-\beta_{all}(t+d-s)\\
