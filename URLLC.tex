...
\begin{align*}
D_{CU}(t) &\geq ((A_{AAU}\otimes S_{AAU}) \otimes S_{DU})\otimes S_{CU}(t) \\
&= A_{AAU}\otimes (S_{AAU}\otimes S_{DU} \otimes S_{CU})(t).
\end{align*}
...
D_{gNB} = A_{gNB}\otimes (S_{AAU}\otimes S_{DU} \otimes S_{CU})(t).
\end{equation}
...
\begin{equation}
\begin{split}
L_{gNB}(t) = &\inf\{d\geqslant0: A_{AAU}(t) - \\
...
we can obtain
\begin{align*}
&P\{L(t)>h(\alpha+x, \beta)\} \\
&\leqslant P\{\{A(t) - D(t+h(\alpha+x, \beta))\} > 0\}  \\
