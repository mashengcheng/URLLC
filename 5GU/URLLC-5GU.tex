...
According to the 3GPP claims, the C-Plane delay should be less than 10ms, whereas the User Plane delay should be less than 1ms.
In this part, we discuss the latency mainly on the UP rather than the C-Plane.
It is because the delay requirement of user plane is higher than that of the control plane.
%
